  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/dogs/profile" className="p-6 border rounded-lg hover:bg-gray-50">
          <h2 className="text-2xl font-semibold mb-2">See Dog Profile</h2>
          <p>See your dog's information</p>
        </Link>
